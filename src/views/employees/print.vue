    ...
    <div class="app-container">
      <el-card>
        <el-row type="flex" justify="end">
          <el-button class="printBtn" type="primary" size="small" @click="startPrint">原生打印</el-button>
          <el-button v-print="'#myTable'" class="printBtn" size="small">插件打印</el-button>
        </el-row>
        <div v-if="type === 'personal'" id="myTable">
...
export default {
  ...
  methods: {
    startPrint() {
      // 调用浏览器 window 全局对象中的自带 print 方法
      window.print()
    },
...
// 媒体查询限定打印时的样式
@media print {
  .sidebar-container, .navbar, .printBtn {
    display: none;
  }
  #app .main-container {
    margin-left: 0;
